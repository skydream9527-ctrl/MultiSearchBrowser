...
public abstract class Hilt_DownloadsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DownloadsFragment() {
    super();
  }

  Hilt_DownloadsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DownloadsFragment_GeneratedInjector) this.generatedComponent()).injectDownloadsFragment(UnsafeCasts.<DownloadsFragment>unsafeCast(this));
    }
  }
