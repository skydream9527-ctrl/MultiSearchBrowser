...
public abstract class Hilt_BookmarksFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BookmarksFragment() {
    super();
  }

  Hilt_BookmarksFragment(int p0) {
    super(p0);
  }
