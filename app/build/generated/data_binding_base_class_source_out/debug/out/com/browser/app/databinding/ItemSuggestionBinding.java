...
public final class ItemSuggestionBinding implements ViewBinding {
  ...
  private ItemSuggestionBinding(@NonNull LinearLayout rootView, @NonNull ImageView suggestionIcon,
  ...
  public static ItemSuggestionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSuggestionBinding((LinearLayout) rootView, suggestionIcon, suggestionText);
    }
