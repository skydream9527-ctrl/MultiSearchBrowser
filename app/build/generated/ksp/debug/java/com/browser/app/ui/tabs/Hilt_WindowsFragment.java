...
public abstract class Hilt_WindowsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WindowsFragment() {
    super();
  }

  Hilt_WindowsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WindowsFragment_GeneratedInjector) this.generatedComponent()).injectWindowsFragment(UnsafeCasts.<WindowsFragment>unsafeCast(this));
    }
  }
